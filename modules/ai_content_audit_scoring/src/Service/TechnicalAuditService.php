...
class TechnicalAuditService {
   ...
   *
   * @return array<string, \Drupal\ai_content_audit_scoring\ValueObject\TechnicalAuditResult>
...
TXT;
   ...
   *
   * @return array<string, \Drupal\ai_content_audit_scoring\ValueObject\TechnicalAuditResult>|null
   ...
   *
   * @param array<string, \Drupal\ai_content_audit_scoring\ValueObject\TechnicalAuditResult> $results
