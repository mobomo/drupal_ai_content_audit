...
namespace Drupal\ai_content_audit_scoring\Entity;

use Drupal\node\NodeInterface;
use Drupal\ai_content_audit_scoring\AiContentAssessmentAccessControlHandler;
use Drupal\ai_content_audit_scoring\AiContentAssessmentListBuilder;
use Drupal\ai_content_audit_scoring\AiContentAssessmentViewsData;
...
#[ContentEntityType(
  ...
  entity_keys: [
   ...
   handlers: [
     ...
     'form' => [
       'delete' => 'Drupal\\ai_content_audit_scoring\\Form\\AiContentAssessmentDeleteForm',
     ],
   ],
   links: [
