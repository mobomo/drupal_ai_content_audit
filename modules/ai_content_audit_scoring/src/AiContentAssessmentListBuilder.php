...
namespace Drupal\ai_content_audit_scoring;
...
class AiContentAssessmentListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity): array {
    /** @var \Drupal\ai_content_audit_scoring\Entity\AiContentAssessment $entity */
   ...
   *
   * @param \Drupal\ai_content_audit_scoring\Entity\AiContentAssessment[] $entities
