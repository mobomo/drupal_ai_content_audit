 ...
 * @coversDefaultClass \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\Technical\HttpsCheck
 */
class HttpsCheckTest extends TestCase {
   ...
   *
   * @return \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\Technical\HttpsCheck
   ...
   *
   * @covers \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\AuditCheckBase::applies
   */
   ...
   *
   * @covers \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\AuditCheckBase::getId
   */
   ...
   *
   * @covers \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\AuditCheckBase::getLabel
   */
   ...
   *
   * @covers \Drupal\ai_content_audit_scoring\Plugin\AuditCheck\AuditCheckBase::getCategory
   */
